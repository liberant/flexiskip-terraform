  ...
  <div>
    ...
    <div className="row" style={PageStyles.row}>
      <div className="col-xs-4 col-sm-5 col-md-5 col-lg-5" style={PageStyles.leftBlock}>
        <div style={PageStyles.title}>Don't Have</div>
      ...
      <div className="col-xs-8 col-sm-7 col-md-7 col-lg-7" style={PageStyles.rightBlock}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-left">
            <Field name="loginId" component={renderInput} type="text" placeholder="Email" icon style={InputStyles} label="" validate={[required, email]}>
              {/* <i className="fa fa-envelope" /> */}
              <span className="handel-mail" />
            </Field>
          </div>
          <div className="text-left">
            <Field name="password" component={InputPasswordField} type="password" placeholder="Password" icon style={InputStyles} label="" validate={[required]} showRules={false}>
          ...
          <div>
            ...
            <a
              ...
              style={PageStyles.forgetPassword}
            >
              Forgot Password?
            </a>
          </div>
