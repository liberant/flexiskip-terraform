...
function* getManageTransactionsList(action) {
  ...
  try {
    const response = yield call(request, {
      // url: `contractor/transactions?limit=${payload.limit}&page=${payload.page}`,
      url: `contractor/transactions?${buildQueryString(payload)}`,
      method: 'get',
...
function* getManageTransactionsById(action) {
  ...
  try {
    ...
    const response = yield call(request, {
      url: `contractor/transactions/${payload.uid}`,
      method: 'get',
...
function* deleteManageTransactionsList(action) {
  ...
  try {
    const response = yield call(request, {
      url: 'contractor/transactions/status',
      data: {
...
function* updateManageTransactionsStatusById(action) {
  ...
  try {
    const response = yield call(request, {
      url: `contractor/transactions/${payload.uid}/status`,
      method: 'put',
