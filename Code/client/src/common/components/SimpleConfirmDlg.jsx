...
class SimpleConfirmDlg extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      ...
      >
        <div style={modalStyles.box}>
          ...
          <div
            style={{ ...modalStyles.link, ...styles.bottomTitle }}
...
export default SimpleConfirmDlg;
