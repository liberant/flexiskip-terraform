...
import { DumpsiteTypeDefs } from '../../../../common/constants/commonTypes';
...
class DumpsiteDetailsLowerSubForm extends React.Component {
  render() {
    const {
      isEdit, isAdd, dumpsiteType,
      products, regions,
    } = this.props;
    const tmpDumpsiteType = (dumpsiteType && dumpsiteType.constructor === String) ?
      dumpsiteType.trim().toLowerCase() : 'percentage';
            ...
            <div className="row">
              <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <Field
                  name="type"
                  label="Dumpsite Type"
                  dropdownLabel="Choose Dumpsite Type"
                  data={DumpsiteTypeDefs}
                  style={
              ...
              <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                {
                  DumpsiteTypeComponents[`${tmpDumpsiteType}`]({ isEdit, data: products })
                }
              </div>
            </div>
            <div className="row">
...
DumpsiteDetailsLowerSubForm.propTypes = {
  isEdit: PropTypes.bool,
  isAdd: PropTypes.bool,
  dumpsiteType: PropTypes.string,
  products: PropTypes.array,
  regions: PropTypes.array,
};

DumpsiteDetailsLowerSubForm.defaultProps = {
  isEdit: false,
  isAdd: false,
  dumpsiteType: 'Percentage',
  products: [],
  regions: [],
};

export default DumpsiteDetailsLowerSubForm;
