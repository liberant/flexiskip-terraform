...
class AdvertisingManagePreviewPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      firstFetchFlag: true,
  ...
  render() {
    const {
      advertisingDetailsFlag, advertising,
...
AdvertisingManagePreviewPage.propTypes = {
...
AdvertisingManagePreviewPage.defaultProps = {
};
