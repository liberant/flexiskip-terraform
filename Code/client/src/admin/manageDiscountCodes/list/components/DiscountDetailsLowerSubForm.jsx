...
import { DiscountTypeDefs } from '../../../../common/constants/commonTypes';
...
class DiscountDetailsLowerSubForm extends React.Component {
  render() {
    const {
      isEdit, isAdd, discountType,
      products, regions,
    } = this.props;
    const tmpDiscountType = (discountType && discountType.constructor === String) ?
            ...
            <div className="row">
              <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <Field
                  name="type"
                  label="Discount Type"
                  dropdownLabel="Choose Discount Type"
                  data={DiscountTypeDefs}
                  style={
              ...
              <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                {
                  DiscountTypeComponents[`${tmpDiscountType}`]({ isEdit, data: products })
                }
              </div>
            </div>
            <div className="row">
...
DiscountDetailsLowerSubForm.propTypes = {
...
DiscountDetailsLowerSubForm.defaultProps = {
  isEdit: false,
  isAdd: false,
...
export default DiscountDetailsLowerSubForm;
