...
import { SimpleCardLayout, ActionButton, InnerDivider } from '../../../../common/components';
import styles, { stylesDetails } from './Styles';
import DiscountDetailsUpperSubForm from './DiscountDetailsUpperSubForm';
import DiscountDetailsLowerSubForm from './DiscountDetailsLowerSubForm';
...
const BackPreviousPage = props => (
  <div style={{ display: 'flex', marginLeft: 30 }}>
    <Link to="/admin/manage-discounts" style={stylesDetails.backArrowBox}>
      <div
        style={{
          fontSize: 48,
        }}
...
class DiscountDetailsForm extends Component {
  constructor(props) {
    super(props);
      ...
      <form onSubmit={handleSubmit}>
        <div className="row" style={stylesDetails.headerBox}>
          <div className="back-previous-box col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <BackPreviousPage
              name={!addFlag ? (data && data.name) : 'Add Discount Code'}
        ...
        <div className="row">
          <div className="col-xs-12">
            <SimpleCardLayout title="Discount Code Details">
              <DiscountDetailsUpperSubForm isEdit={editFlag} isAdd={addFlag} />
              <InnerDivider />
              <DiscountDetailsLowerSubForm
                isEdit={editFlag}
                isAdd={addFlag}
...
DiscountDetailsForm.defaultProps = {
  editFlag: false,
  addFlag: false,
  data: {},
  handleDeletion: null,
...
export default withRouter(DiscountDetailsForm);
