...
class NewBusinessContractorInformationSubForm extends React.Component {
  render() {
...
NewBusinessContractorInformationSubForm.propTypes = {
  isEdit: PropTypes.bool,
};

NewBusinessContractorInformationSubForm.defaultProps = {
  isEdit: false,
};

export default NewBusinessContractorInformationSubForm;
