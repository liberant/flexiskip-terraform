...
class NewLicenceInformationSubForm extends React.Component {
  render() {
...
NewLicenceInformationSubForm.propTypes = {
  isEdit: PropTypes.bool,
};

NewLicenceInformationSubForm.defaultProps = {
  isEdit: false,
};

export default NewLicenceInformationSubForm;
